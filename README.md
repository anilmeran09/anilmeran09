...
**Cloud & DevOps:**  
- AWS (Lambda, S3, ECS, ECR, SNS, Terraform)  
- ETL Pipelines  
- Data Warehousing  
...
### 🔹 Velocity Media  
Automated data extraction and integration system that collects data from multiple sources and centralizes it into a database.

**Tech Stack:** Python, SQL, AWS (Lambda, S3, SNS), Apify  
**Features:**  
- Scraped data from Google Maps and Facebook  
- Stored raw JSON data in S3  
- Transformed data using AWS Lambda  
...
### 🔹 Content Elbert  
Integrated data labeling system for efficient data annotation and management.

**Tech Stack:** Python, Django, React, PostgreSQL, Docker, AWS (ECS, ECR, Lambda, S3, Terraform)  
**Features:**  
...
User authentication system with session management and two-step verification.

**Tech Stack:** Python, Django, SQLite/PostgreSQL  
**Features:**  
- Login & Logout  
- Session timeout  
...
A RESTful CRUD application for managing items using Django.
...
![Top Langs](https://github-readme-stats-sigma-five.vercel.app/api/top-langs/?username=anilmeran09&layout=compact)
---
